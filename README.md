# Full Stack Developer Interview at Keel. 

Thank you for interviewing with Keel. Please note this is a full time job and you’re required to work 40 hrs/week. You’ll not be legally allowed to work for anyone else when you’re working with us. 

You will be working on these technologies when you’re working with us. 
* ReactJS and Python Django
* Docker 
* Kubernetes
* GitLab CI / Jenkins
...
- Ability to translate Wireframes and PSD Designs into functional web apps using HTML5, React, Django, and MySql
- Binding of UI elements to JavaScript object models
- Creating RESTful services with Django
...
#### Qualifications
- 1+ years minimum in creating complex HTML based solutions
- Detail oriented experience as a Web Developer creating ReactJS based solutions
- 1-2 years with Django/Flask and Python.
...
- Live Programming & System Design (1-2 hrs of programming) 
...
Technically, Canada. Honestly, it doesn't matter. You can work out of anywhere you like. This job is remote.  

**Is this job full time?**

Yes. We're NOT looking for part time employees. 

**What are the minimum requirements to work at Keel ?**
...
Yes, You can use React/Angular/Vue or any other library of similar complexity.
...
You'll be paid in CAD. Contact soemone who sent you an interview invite to know how much we'd pay. 
